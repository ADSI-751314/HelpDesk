<form action="controller/tecnicos_controller.php?petition=crear" method="POST" name="frm_tecnicos_crear">
			<table border="1" >
				<tr>
					<td colspan="2" ALIGN="CENTER" class="textos">  TECNICOS  </td>					
				</tr>
				<tr>
				...
				<tr>
					...
					<td><SELECT NAME="cboEspecialidad"> 
				...
				<tr>
					...
					<td colspan="2"> 
					<CENTER>
					<input  type="submit"  name="btnGuardar" value="GUARDAR" onClick="guardar()">
