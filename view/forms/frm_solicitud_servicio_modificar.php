<form name="frmServicioModificar" action="/HelpDesk/controller/servicios_controller.php?peticion=modificar" method="POST">
<br />
<br />
<br /><br />
 ...
 <tr colspan="6" >
 <b>Modificaci&oacute;n de Servicios</b>
    ...
    <tr>
    <td colspan="6" align="center"> <input type="submit" name="btnModificar" value="MODIFICAR" class="btn btn-lg btn-success"/> </td>
    </tr>
