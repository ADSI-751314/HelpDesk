 ...
 //TABLA TEC_SERV_DET
    ...
    public function __construct()
   {
    ...
    public function consultar(){
        ...
        $sql="select servicios.pk_ser_ticket,servicios.ser_descripcion,servicios.ser_fecha,
detalles_servicios.det_descripcion,
detalles_servicios.det_fecha,
tec_serv_det.pk_tsd_codigo,
tec_serv_det.fk_tec_codigo";
